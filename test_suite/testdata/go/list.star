...
[1, 2] + (3, 4) ### (unknown.*list \+ tuple|unsupported operand|parameters mismatch)
---
(1, 2) + [3, 4] ### (unknown.*tuple \+ list|unsupported operand|parameters mismatch)
---
abc = ["a", "b", "c"]
...
f5() ### (unknown binary op|unsupported operand|parameters mismatch)
---
...
iterator1() ### (assign to element.* during iteration|trying to mutate a locked object|Cannot mutate)
---
...
iterator2() ### (remove.*during iteration|trying to mutate a locked object|Cannot mutate)
---
...
iterator3() ### (append.*during iteration|trying to mutate a locked object|Cannot mutate)
---
...
iterator4() ### (extend.*during iteration|trying to mutate a locked object|Cannot mutate)
---
...
iterator5() ### (append.*during iteration|trying to mutate a locked object|Cannot mutate)
